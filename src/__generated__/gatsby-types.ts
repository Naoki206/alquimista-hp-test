...
declare namespace GatsbyTypes {
  ...
  type ContentfulImagePlaceholder = 'dominantColor' | 'tracedSVG' | 'blurred' | 'none';
  ...
  type ContentfulLayoutCopy = ContentfulReference &
    ContentfulEntry &
    Node & {
      readonly contentful_id: Scalars['String'];
      readonly id: Scalars['ID'];
  ...
  type ContentfulLesson = ContentfulReference &
    ContentfulEntry &
    Node & {
      readonly contentful_id: Scalars['String'];
      readonly id: Scalars['ID'];
  ...
  type ContentfulCourse = ContentfulReference &
    ContentfulEntry &
    Node & {
      readonly contentful_id: Scalars['String'];
      readonly id: Scalars['ID'];
  ...
  type ContentfulLayoutHeroImage = ContentfulReference &
    ContentfulEntry &
    Node & {
      readonly contentful_id: Scalars['String'];
      readonly id: Scalars['ID'];
  ...
  type ContentfulCategory = ContentfulReference &
    ContentfulEntry &
    Node & {
      readonly contentful_id: Scalars['String'];
      readonly id: Scalars['ID'];
  ...
  type ContentfulLessonCodeSnippets = ContentfulReference &
    ContentfulEntry &
    Node & {
      readonly contentful_id: Scalars['String'];
      readonly id: Scalars['ID'];
  ...
  type ContentfulLayout = ContentfulReference &
    ContentfulEntry &
    Node & {
      readonly contentful_id: Scalars['String'];
      readonly id: Scalars['ID'];
  ...
  type ContentfulLessonImage = ContentfulReference &
    ContentfulEntry &
    Node & {
      readonly contentful_id: Scalars['String'];
      readonly id: Scalars['ID'];
  ...
  type ContentfulLayoutHighlightedCourse = ContentfulReference &
    ContentfulEntry &
    Node & {
      readonly contentful_id: Scalars['String'];
      readonly id: Scalars['ID'];
  ...
  type ContentfulLessonCopy = ContentfulReference &
    ContentfulEntry &
    Node & {
      readonly contentful_id: Scalars['String'];
      readonly id: Scalars['ID'];
  ...
  type ContentfulNews = ContentfulReference &
    ContentfulEntry &
    Node & {
      readonly contentful_id: Scalars['String'];
      readonly id: Scalars['ID'];
  ...
  type ThreeNewContentsQuery = {
    readonly allContentfulPost: {
      readonly edges: ReadonlyArray<{
        readonly node: Pick<
          ContentfulPost,
          'title' | 'category' | 'author' | 'slug' | 'updatedAt'
        > & {
  ...
  type MenuQueryQuery = {
    readonly allContentfulPost: Pick<ContentfulPostConnection, 'distinct'>;
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<{
        ...
        readonly blog: Maybe<{
          readonly menu: Maybe<
            Pick<SiteSiteMetadataBlogMenu, 'all' | 'new' | 'popular' | 'writer' | 'category'>
          >;
        }>;
      }>;
    }>;
  ...
  type ThreePopularContentsQuery = {
    readonly allContentfulPost: {
      readonly edges: ReadonlyArray<{
        readonly node: Pick<
          ContentfulPost,
  ...
  type HeaderQueryQuery = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<{
        readonly menu: Maybe<
          Pick<
            SiteSiteMetadataMenu,
            'iconPath' | 'aboutUs' | 'vision' | 'service' | 'blog' | 'news' | 'member' | 'contactUs'
          >
        >;
      }>;
    }>;
  ...
  type userskamatsukanaokialquimistaalquimistaHpsrcpages404Jsx3159585216QueryVariables = Exact<{
    [key: string]: never;
  }>;

  type userskamatsukanaokialquimistaalquimistaHpsrcpages404Jsx3159585216Query = {
  ...
  type BlogWriterIndexQuery = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<{
        readonly member: Maybe<{
          readonly engineer: Maybe<
            ReadonlyArray<
              Maybe<
                Pick<SiteSiteMetadataMemberEngineer, 'description' | 'name' | 'role' | 'twitter'>
              >
            >
          >;
        }>;
  ...
  type NewsIndexQuery = {
    readonly allContentfulNews: {
      readonly edges: ReadonlyArray<{
        readonly node: Pick<ContentfulNews, 'slug' | 'title' | 'createdAt'> & {
          readonly image: Maybe<
            Pick<ContentfulAsset, 'title'> & {
              readonly file: Maybe<Pick<ContentfulAssetFile, 'url'>>;
            }
  ...
  type ContentfulNewsPostBySlugQuery = {
    readonly contentfulNews: Maybe<
        ...
        readonly content: Maybe<
          Pick<ContentfulNewsContent, 'raw'> & {
            readonly references: Maybe<
              ReadonlyArray<
                Maybe<
                  { readonly __typename: 'ContentfulAsset' } & Pick<
                    ContentfulAsset,
                    'id' | 'contentful_id' | 'title' | 'gatsbyImageData'
  ...
  type ContentfulBlogPostBySlugQuery = {
  ...
  type userskamatsukanaokialquimistaalquimistaHpsrcpagesusingTypescriptTsx2907560070QueryVariables =
    Exact<{ [key: string]: never }>;

  type userskamatsukanaokialquimistaalquimistaHpsrcpagesusingTypescriptTsx2907560070Query = {
    ...
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<{
        readonly footer: Maybe<
          Pick<
            SiteSiteMetadataFooter,
            'address' | 'companyName' | 'companyOverview' | 'contact' | 'privacyPolicy'
          >
        >;
      }>;
    }>;
  ...
  type TopIndexQuery = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<{
        readonly member: Maybe<{
          readonly designer: Maybe<
            ReadonlyArray<
              Maybe<Pick<SiteSiteMetadataMemberDesigner, 'description' | 'name' | 'role'>>
            >
          >;
          readonly engineer: Maybe<
            ReadonlyArray<
          ...
          readonly marketing: Maybe<
            ReadonlyArray<
              Maybe<Pick<SiteSiteMetadataMemberMarketing, 'description' | 'name' | 'role'>>
            >
          >;
        }>;
      }>;
    ...
    readonly allContentfulNews: {
      readonly edges: ReadonlyArray<{
        readonly node: Pick<ContentfulNews, 'title' | 'slug' | 'createdAt'> & {
          readonly image: Maybe<
            Pick<ContentfulAsset, 'title'> & {
              readonly file: Maybe<Pick<ContentfulAssetFile, 'url'>>;
            }
