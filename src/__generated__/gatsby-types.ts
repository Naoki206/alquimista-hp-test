...
type userskamatsukanaokialquimistaHpSpsrccomponentsseoJsx2841359383QueryVariables = Exact<{ [key: string]: never; }>;


type userskamatsukanaokialquimistaHpSpsrccomponentsseoJsx2841359383Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'description'>
      & { readonly social: Maybe<Pick<Social, 'twitter'>> }
    )> }> };

type userskamatsukanaokialquimistaHpSpsrcpages404Jsx3159585216QueryVariables = Exact<{ [key: string]: never; }>;


type userskamatsukanaokialquimistaHpSpsrcpages404Jsx3159585216Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'title'>> }> };
...
type userskamatsukanaokialquimistaHpSpsrcpagesusingTypescriptTsx2907560070QueryVariables = Exact<{ [key: string]: never; }>;


type userskamatsukanaokialquimistaHpSpsrcpagesusingTypescriptTsx2907560070Query = { readonly site: Maybe<Pick<Site, 'buildTime'>> };
