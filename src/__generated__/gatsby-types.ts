...
declare namespace GatsbyTypes {
  ...
  type ThreeNewContentsQuery = {
    readonly allContentfulPost: {
      readonly edges: ReadonlyArray<{
        readonly node: Pick<ContentfulPost, 'title' | 'category' | 'author' | 'slug' | 'date'> & {
  ...
  type BlogCategoryIndexQuery = {
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<{ readonly blog: Maybe<Pick<SiteSiteMetadataBlog, 'title'>> }>;
    }>;
    readonly allContentfulPost: Pick<ContentfulPostConnection, 'distinct'>;
  };
    ...
    readonly site: Maybe<{
      readonly siteMetadata: Maybe<{
        readonly member: Maybe<
          ReadonlyArray<
            Maybe<Pick<SiteSiteMetadataMember, 'description' | 'name' | 'role' | 'twitter'>>
          >
        >;
      }>;
    }>;
